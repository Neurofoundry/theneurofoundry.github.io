...
(function() {
  ...
  const config = {
    ...
    mouseInfluence: 100,
    colors: {
      particle: 'rgba(224, 71, 60, 0.6)',
      particleGlow: 'rgba(224, 71, 60, 0.3)',
      connection: 'rgba(224, 71, 60, 0.15)',
      connectionHighlight: 'rgba(255, 123, 110, 0.3)'
    }
  };
      ...
      for (let j = i + 1; j < particles.length; j++) {
        ...
        if (dist < config.connectionDistance) {
          ...
          if (mouseDist < config.mouseInfluence) {
            ...
            ctx.strokeStyle = `rgba(224, 71, 60, ${opacity * 0.15})`;
            ctx.lineWidth = 1;
          }
