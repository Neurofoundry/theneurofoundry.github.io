...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a simple Browser Use smoke test.")
    parser.add_argument(
        "--task",
        default=DEFAULT_SMOKE_TASK,
        help="Optional override for the smoke task.",
    )
    ...
    parser.add_argument("--max-steps", type=int, default=8, help="Maximum Browser Use steps.")
...
async def main_async() -> int:
    ...
    result = await run_browser_task(
        ...
        timeout_seconds=args.timeout,
        transcript_prefix="browser-use-smoke",
