  ...
  async fetch(request, env) {
    ...
    if (request.method === "GET" && url.pathname === "/health") {
      return jsonResponse(200, {
        ok: true,
        service: "apprentice",
        endpoints: ["/fusion/cdp", "/fusion/acp", "/fusion/sip", "/fusion/synth", "/fusion", "/analyze", "/diag/models"],
        modes: MODES
      }, corsHeaders);
    }
...
// .wrangler/tmp/bundle-eWP1pJ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-eWP1pJ/middleware-loader.entry.ts
